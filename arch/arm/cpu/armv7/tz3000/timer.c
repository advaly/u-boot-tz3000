...
#define TIMER_LOAD		TZ3000_PTMR_LOAD
#define TIMER_COUNTER		TZ3000_PTMR_COUNTER
#define TIMER_CTRL		TZ3000_PTMR_CONTROL
...
#define TIMER_CLOCK		tz3000_periph_clk
